...
private struct WorkOrderConstraints {
...
private func insertMissingAnchored(
...
private func stableIDLessThan(_ lhs: WorkStableID, _ rhs: WorkStableID) -> Bool {
    lhs.rawValue.uuidString < rhs.rawValue.uuidString
}

private extension Set<WorkStableID> {
