...
Phase 0 / 1 / 2 / 3 / 4 / 旧 Phase UI / Phase UI2 / Phase 4.5 / Toolbar-1 / Toolbar-2 / UI-FIX-1〜5 / UI-REV-1〜9 は完了済み(→ 変更履歴)。Phase 5前のWorkbench手触り調整として、次は **UI-REF-1「Glass chrome拡張」**。詳細な作業指示書は [UIREFRESH.md](UIREFRESH.md)。
