...
Phase 0 / 1 / 2 / 3 / 4 / 旧 Phase UI / Phase UI2 / Phase 4.5 / Toolbar-1 / Toolbar-2 / UI-FIX-1 / UI-FIX-2a / UI-FIX-2b / UI-FIX-2c / UI-FIX-3 は完了済み(→ 変更履歴)。次は **UI-FIX-4「Toolbarのanchored popover」**。詳細な作業指示書は [UIFIX.md](UIFIX.md)。
