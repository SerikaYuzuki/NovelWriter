...
Phase 0 / 1 / 2 / 3 / 4 / 旧 Phase UI / Phase UI2 / Phase 4.5 / Toolbar-1 / Toolbar-2 は完了済み(→ 変更履歴)。次は **Phase 5-1「プレーンテキスト書き出し」**(4.5-1c のリネームは随時可)。詳細な作業指示書は [PHASE5.md](PHASE5.md)。上部 chrome は [TOOLBAR.md](TOOLBAR.md)。
