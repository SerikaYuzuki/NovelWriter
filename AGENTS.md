...
- 次: **UI-FIX-2c(階層型の執筆Outline + 追加menu)**。UI-FIX-2aで保存形式、UI-FIX-2bでAppStateの話選択と操作が完了した。詳細は [docs/UIFIX.md](docs/UIFIX.md)。Chapter / Episode階層を含むUI Fix完了後にPhase 5-1へ進む。Toolbarの現行設計は [docs/TOOLBAR.md](docs/TOOLBAR.md)
