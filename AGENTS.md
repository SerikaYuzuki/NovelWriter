...
**設計の正は [docs/DESIGN.md](docs/DESIGN.md)、決定の記録は [docs/DECISIONS.md](docs/DECISIONS.md)(D-001〜)。この2つを読んでから作業すること。** 次にやるべきタスクは DESIGN.md の「11. 直近の次タスク」にある(**現在進行中の作業指示書は [docs/UIREVISION.md](docs/UIREVISION.md)**。UI Fix の完了記録は [docs/UIFIX.md](docs/UIFIX.md)、Phase 5は再設計完了まで待機。Phase UI2 と Phase 4 の完了記録は [docs/UIDESIGN.md](docs/UIDESIGN.md) / [docs/PHASE4.md](docs/PHASE4.md))。
...
- 次: **UI-REV-1(Glass Outline)**。UI-FIXの方向違いをUI-REV-1〜9で修正してからPhase 5-1へ進む。詳細は [docs/UIREVISION.md](docs/UIREVISION.md)
