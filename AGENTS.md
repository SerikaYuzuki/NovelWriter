...
- 次: **UI-FIX-3(プロット章Outline + 伏線split)**。UI-FIX-2aで保存形式、UI-FIX-2bでAppState、UI-FIX-2cで執筆Outlineと追加menuが完了した。詳細は [docs/UIFIX.md](docs/UIFIX.md)。Chapter / Episode階層を含むUI Fix完了後にPhase 5-1へ進む。Toolbarの現行設計は [docs/TOOLBAR.md](docs/TOOLBAR.md)
