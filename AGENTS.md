...
- 次: **UI-FIX-2b(AppStateの話選択と操作)**。UI-FIX-2aでNovelCoreとNovelStorageのChapter / Episodeモデル、`.novelpkg` v3移行が完了した。詳細は [docs/UIFIX.md](docs/UIFIX.md)。Chapter / Episode階層を含むUI Fix完了後にPhase 5-1へ進む。Toolbarの現行設計は [docs/TOOLBAR.md](docs/TOOLBAR.md)
