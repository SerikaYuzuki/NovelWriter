...
- Phase 0(基盤)/ Phase 1(最小執筆環境)/ Phase 2(Editorプラグイン基盤 + 自動インデント)/ Phase 3(基本操作強化)/ Phase 4-1(メタデータ基盤 + 章メモ + 文字数)/ Phase 4-2(キャラクター管理・最小)完了
...
- 次: Phase 4-3(キャラクター ⇄ 本文の連携)。**サブフェーズ分解済みの作業指示書 = [docs/PHASE4.md](docs/PHASE4.md)。1サブフェーズ = 1PR で進めること**
